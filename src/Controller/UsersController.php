...
class UsersController extends AppController
{
    ...
    public function login(){
        if($this->request->is('post')){
            $user=$this->Auth->identify();//verifica los datos de autentifiación
            if($user){
    ...
    public function add(){
        ...
        if($this->request->is('post')){
            //debug($this->request->data); imprimir la request
    ...
    public function edit($id=null){
        ...
        if($this->request->is(['patch','post','put'])){
            ...
            if($this->Users->save($user)){
                ...
                $this->Flash->error('El usuario no puede ser modificado. Por favor, intente nuevamente');
            }
    ...
    public function searchjson(){
        ...
        if(!empty($this->request->query['term'])){
            ...
            foreach($terms as $term){
                $conditions[]=array('first_name LIKE'=>'%'.$term.'%');
            }
